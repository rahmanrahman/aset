            ...
            <div class="card-body">
                ...
                <form action="{{ route('komputer.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class='form-group mb-3'>
                        ...
                        <input type='text' name='nama' class='form-control @error(' nama') is-invalid @enderror' value='{{ $item->nama ?? old('nama') }}'>
                        @error('nama')
                        <div class='invalid-feedback'>
                            {{ $message }}
                        </div>
                    ...
                    <div class='form-group mb-3'>
                        ...
                        <textarea name='spesifikasi' id='spesifikasi' cols='30' rows='3' class='form-control @error(' spesifikasi') is-invalid @enderror'>{{ old('spesifikasi') }}</textarea>
                        @error('spesifikasi')
                        <div class='invalid-feedback'>
                            {{ $message }}
                        </div>
                    ...
                    <div class='form-group'>
                        ...
                        <select name='sistem_operasi_id' id='sistem_operasi_id' class='form-control @error(' sistem_operasi_id') is-invalid @enderror'>
                    ...
                    <div class='form-group'>
                        ...
                        <select name='sistem_operasi_detail_id' id='sistem_operasi_detail_id' class='form-control @error(' sistem_operasi_detail_id') is-invalid @enderror'>
                    ...
                    <div class='form-group'>
                        ...
                        <select name='ip_address_id' id='ip_address_id' class='form-control @error(' ip_address_id') is-invalid @enderror'>
                    ...
                    <div class='form-group mb-3'>
                        ...
                        <input type='text' name='nama_user' id='nama_user' class='form-control @error(' nama_user') is-invalid @enderror' value='{{ old('nama_user') }}'>
                        @error('nama_user')
                        <div class='invalid-feedback'>
                            {{ $message }}
                        </div>
                    ...
                    <div class='form-group mb-3'>
                        ...
                        <input type='date' name='tanggal_pembelian' id='tanggal_pembelian' class='form-control @error(' tanggal_pembelian') is-invalid @enderror' value='{{ old('tanggal_pembelian') }}'>
