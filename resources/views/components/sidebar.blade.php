<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#kerusakan" aria-expanded="false" aria-controls="kerusakan">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#pergantian" aria-expanded="false" aria-controls="pergantian">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="master_data">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('ipaddress.index') }}"> IP </a>
                    </li>
                    <li class="nav-item">
